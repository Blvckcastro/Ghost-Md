...
france({ nomCom: "tempmail", reaction: "😌", nomFichier: __filename }, async (dest, zk, commandeOptions) => {
    ...
    let z = '*GHOST-MD* Temporary emails,Powered by *Blvck Castro* \n\n ' + "Click the links below to create unlimited TEMPORARY Emails. Powered by *GHOST-MD.*\n\n";
    let d = ' 1️⃣ https://tempumail.com\n\n 2️⃣ https://etempmail.com\n\n 3️⃣ https://ghostmail.one\n\n 4️⃣ https://tempmailid.com';
    let varmess = z + d;
    var img = 'https://telegra.ph/file/fa95f40cb4ff5d8914867.jpg';
